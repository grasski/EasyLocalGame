...
-keep class com.dabi.easylocalgame.payloadUtils.data.ClientPayloadType { *; }
-keep class com.dabi.easylocalgame.payloadUtils.data.ServerPayloadType { *; }
-keep class com.dabi.easylocalgame.clientSide.data.** { *; }
-keep class com.dabi.easylocalgame.serverSide.data.** { *; }
